...
int melody[] = {
  ...
  NOTE_,NOTE_A5,NOTE_D5,NOTE_D5,NOTE_D5,NOTE_D5,NOTE_G5,
...
int melody2[] = {
  NOTE_FS5,NOTE_FS5,NOTE_FS5,NOTE_AS5,NOTE_DS5,NOTE_DS5,NOTE_DS5,NOTE_CS5,
  NOTE_,NOTE_AS5,NOTE_AS5,NOTE_AS5,NOTE_AS5,NOTE_F5,NOTE_F5,NOTE_F5,NOTE_DS5,
  NOTE_, NOTE_FS5,NOTE_FS5,NOTE_DS5,NOTE_FS5,NOTE_DS5,NOTE_FS5,NOTE_GS5,NOTE_AS5,
  NOTE_,NOTE_FS5,NOTE_FS5,NOTE_CS5,NOTE_AS5,NOTE_FS5,NOTE_FS5,NOTE_FS5,NOTE_F5,NOTE_F5,NOTE_F5,NOTE_DS5,NOTE_FS5,
  NOTE_,NOTE_FS5,NOTE_FS5,NOTE_DS5,NOTE_FS5,NOTE_DS5,NOTE_FS5,NOTE_GS5,NOTE_AS5,NOTE_FS5,NOTE_FS5,NOTE_CS5,NOTE_AS5,NOTE_FS5,NOTE_GS5
  };
int noteDurations2[] = {
   4, 4, 4, 4, 4, 4, 4, 4,
   4, 4, 4, 4, 4, 4, 4, 4, 4,
...
if(nexttone)
{
  ...
  tone(3, melody[cnt], noteDuration);
  ...
  tone(3, melody2[cnt], noteDuration);
   pauseBetweenNotes = noteDuration * 1.30;
   nexttone=false;
   } 
    for(int i = 0; i < 8 ; i++){
